...
int main(int Arguments, char* Argument[])
{
  ...
  int Tip[100];   // Also remember all the newly added tips of the growing triangle
  int Sum = 0;
  ...
  /* Operation */
    ...
    // When the triangle is complete, work backwards in time from the array of Tips
    for (Number=0; Index; Index--)
      Number = Tip[Index-1] - Number;
    printf("After %d numbers on InputLine #%d, prequel should be %d\n", TokenNr, InputLineNr, Number);
    Sum += Number;
  } /* while (fgets) */
